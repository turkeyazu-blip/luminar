...
public class ElasticAnimation extends Animation {
   ...
   protected double getEquation(double x) {
      ...
      return Math.pow(2.0D, -10.0D * (this.reallyElastic ? Math.sqrt(x1) : x1)) * (double)MathHelper.func_76126_a((float)((x1 - elasticity / 4.0D) * (6.283185307179586D / elasticity))) + 1.0D;
   }
}
