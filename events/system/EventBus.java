...
public class EventBus {
   ...
   static final class LoggingHandler implements SubscriberExceptionHandler {
      ...
      private static Logger logger(SubscriberExceptionContext context) {
         String var10000 = EventBus.class.getName();
         return Logger.getLogger(var10000 + "." + context.getEventBus().identifier());
      }

      private static String message(SubscriberExceptionContext context) {
         Method method = context.getSubscriberMethod();
         String var10000 = method.getName();
         return "Exception thrown by subscriber method " + var10000 + "(" + method.getParameterTypes()[0].getName() + ") on subscriber " + context.getSubscriber() + " when dispatching event: " + context.getEvent();
      }
   }
}
